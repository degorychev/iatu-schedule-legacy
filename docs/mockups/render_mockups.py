...
def render_conflict_mock():
    ...
    conflicts = [
        ...
        (
            "В одном кабинете (413) обнаружено несколько дисциплин одновременно!",
            [
                ["03.02.2022", "11:50", "АИСТбд-21", "Базы данных", "пр.", "Камалов Л.Е.", "413", "week3.xls"],
                ["03.02.2022", "11:50", "ИБбд-31", "Компьютерные сети", "лаб.", "Камалов Л.Е.", "413", "week3.xls"],
            ],
        ),
    ]

    for alert, data in conflicts:
        rect(draw, (90, y, 1190, y + 52), (242, 222, 222), (235, 204, 209))
        text(draw, (112, y + 16), alert, font_b, (132, 53, 52))
        y += 70

        col_widths = [95, 75, 120, 310, 65, 200, 75, 100]

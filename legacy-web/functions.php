<?php
// Legacy note:
// Это исторический PHP-интерфейс расписания. Он сохранен как часть кейса 2017-2019,
// а не как пример современной PHP-архитектуры: в коде смешаны SQL, HTML и логика
// отображения, что было типично для быстрого внутреннего инструмента.
session_start();
